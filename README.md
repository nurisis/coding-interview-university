...
- [x] Cracking the coding interview :book:
...
- ### Arrays
    ...
    - [ ] StringBuilder
        - Implement my own string builder
...
- ### Binary search trees: BSTs
    ...
    - C/C++:
        ...
        - [xxs] [Delete a node from Binary Search Tree (video)](https://www.youtube.com/watch?v=gcULXE7ViZw&list=PL2_aWCzGMAwI3W_JlcBbtYTwiQSsOTa6P&index=36)
...
- [ ] Graphs (review and more):
    ...
    - [x] [DFS/DFS 기초 강의](https://www.youtube.com/watch?v=gl5RhtU2mF8)
    ...
    - [ ] [6.006 Dijkstra (video)](https://www.youtube.com/watch?v=2E7MmKv0Y24&index=16&list=PLUl4u3cNGP61Oq3tWYp6V_F-5jb5L2iHb)
        - [x] [Good explaning dijkstra in youtube](https://www.youtube.com/watch?v=XB4MIexjvY0)
    - [ ] [6.006 Bellman-Ford (video)](https://www.youtube.com/watch?v=ozsuci5pIso&list=PLUl4u3cNGP61Oq3tWYp6V_F-5jb5L2iHb&index=17)
        - [x] [Good explaning video](https://www.youtube.com/watch?v=FtN3BYH2Zes)
...
- ### Recursion
    ...
    - [x] [Leetcode curriculum](https://leetcode.com/explore/featured/card/recursion-i/253/conclusion/1650/)
...
- ### Dynamic Programming
    ...
    - [ ] [Leetcode curriculum](https://leetcode.com/explore/featured/card/dynamic-programming/)
    - [ ] Practice:
